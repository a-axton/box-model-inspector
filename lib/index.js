...
BoxModelInspector.prototype._calculatePadding = function () {
  ...
  border.wrapper.style.width = elDimensions.outerWidth - paddingLeft - paddingRight + 'px';
  border.wrapper.style.height = elDimensions.outerHeight - paddingTop - paddingBottom + 'px';
  border.wrapper.style.left = paddingLeft + 'px';
  border.wrapper.style.top = paddingTop + 'px';
  border.wrapper.style['background-position'] = borderLeft + 'px ' + '0px';

  padding.wrapper.style.width = elDimensions.outerWidth + 'px';
  padding.wrapper.style.height = elDimensions.outerHeight + 'px';
  padding.wrapper.style.left = '0px';
  padding.wrapper.style.top = '0px';
  padding.wrapper.style['background-position'] = borderLeft + 'px ' + '0px';

  border.borderTop.style.height = borderTop + 'px';
  border.borderTop.style.width = elDimensions.outerWidth - paddingLeft - paddingRight + 'px';
  border.borderTop.style.top = '0px';
  border.borderTop.style.left = '0px';

  border.borderRight.style.height = elDimensions.outerHeight - paddingTop - paddingBottom - borderTop - borderBottom + 'px';
  ...
  border.borderBottom.style.width = elDimensions.outerWidth - paddingLeft - paddingRight + 'px';
  border.borderBottom.style.left = '0px';
  border.borderBottom.style.bottom = '0px';

  border.borderLeft.style.height = elDimensions.outerHeight - paddingTop - paddingBottom - borderTop - borderBottom + 'px';
  ...
  padding.paddingTop.style.width = elDimensions.outerWidth + 'px';
  padding.paddingTop.style.top = '0px';
  padding.paddingTop.style.left = '0px';

  padding.paddingRight.style.height = elDimensions.outerHeight - paddingTop - paddingBottom + 'px';
  ...
  padding.paddingBottom.style.width = elDimensions.outerWidth + 'px';
  padding.paddingBottom.style.bottom = '0px';
  padding.paddingBottom.style.left = '0px';

  padding.paddingLeft.style.height = elDimensions.outerHeight - paddingTop - paddingBottom + 'px';
